...
function sourceFromFileOrUrlArray(name, filesOrUrls) {
    return __awaiter(this, void 0, void 0, function* () {
        const samples = yield Promise.all(filesOrUrls.map(NodeIO_1.readableFromFileOrURL));
                ...
                for (let file of files) {
                    ...
                    if (file.endsWith(".url") || file.endsWith(".json")) {
                        sourcesInDir.push({
                            kind: "json",
                            name,
                            samples: [yield NodeIO_1.readableFromFileOrURL(fileOrUrl)]
                        });
                    }
                        ...
                        graphQLSchema = yield NodeIO_1.readableFromFileOrURL(fileOrUrl);
                        ...
                        graphQLSources.push({
                            ...
                            name,
                            schema: undefined,
                            query: yield get_stream_1.getStream(yield NodeIO_1.readableFromFileOrURL(fileOrUrl))
                        });
                    }
                }
...
function getSourceURIs(options) {
    return __awaiter(this, void 0, void 0, function* () {
        if (options.srcUrls !== undefined) {
            const json = quicktype_core_1.parseJSON(yield NodeIO_1.readFromFileOrURL(options.srcUrls), "URL grammar", options.srcUrls);
...
function typeSourcesForURIs(name, uris, options) {
    return __awaiter(this, void 0, void 0, function* () {
        switch (options.srcLang) {
            case "json":
                return [yield sourceFromFileOrUrlArray(name, uris)];
            case "schema":
...
function getSources(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const dataDir of directories) {
            sources = sources.concat(yield samplesFromDirectory(dataDir));
        }
...
function makeInputData(sources, targetLanguage, additionalSchemaAddresses, handleJSONRefs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const source of sources) {
            switch (source.kind) {
                ...
                case "json":
                    ...
                    break;
                case "schema":
                    yield inputData.addSource("schema", source, () => new quicktype_core_1.JSONSchemaInput(new NodeIO_1.FetchingJSONSchemaStore(), [], additionalSchemaAddresses));
                    break;
                default:
                    return quicktype_core_1.assertNever(source);
            }
...
function makeQuicktypeOptions(options, targetLanguages) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (options.srcLang) {
            case "graphql":
                ...
                if (options.graphqlIntrospect !== undefined) {
                    schemaString = yield GraphQLIntrospection_1.introspectServer(options.graphqlIntrospect, collection_utils_1.withDefault(options.httpMethod, "GET"), collection_utils_1.withDefault(options.httpHeader, []));
                ...
                for (const queryFile of options.src) {
                    ...
                    const query = yield get_stream_1.getStream(yield NodeIO_1.readableFromFileOrURL(queryFile));
        ...
        quicktypeOptions.inputData = yield makeInputData(sources, lang, options.additionalSchema, quicktypeOptions.ignoreJsonRefs !== true);
